...
export class SchoolHomeComponent implements OnInit {
  ...
  submitreview(){
    var user=this.fdb.list('Andrapradesh/'+this.district+'/'+this.subarea+'/'+this.school+'/visitreport'+this.reportForm.get('date').value+'/'+this.reportForm.get('role').value+'/'+this.reportForm.get('name').value);
    user.set(this.reportForm.get('review').value,"");
    this.reportList=this.fdb.list('Andrapradesh/'+this.district+'/'+this.subarea+'/'+this.school+'/visitreport'+this.reportForm.get('date').value+'/'+this.reportForm.get('role').value+'/'+this.reportForm.get('name').value).snapshotChanges();
  }
  removereview(){
    this.fdb.database.ref('Andrapradesh/'+this.district+'/'+this.subarea+'/'+this.school+'/visitreport'+this.reportForm.get('date').value+'/'+this.reportForm.get('role').value+'/'+this.reportForm.get('name').value);
  }
