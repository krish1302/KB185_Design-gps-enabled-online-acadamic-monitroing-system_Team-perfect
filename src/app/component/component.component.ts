...
submitfeedback(){
  var self=this;
  this.fdb.database.ref('Andrapradesh/'+this.district+'/'+this.area+'/'+this.school+'/feedback/'+this.feedbackForm.get('user').value).once('value',function(datasnap){
    if(datasnap.exists()){
      var val1=datasnap.child('key1').val();
      var val2=datasnap.child('key2').val();
      var val3=datasnap.child('key3').val();
      var val4=datasnap.child('key4').val();
      var val5=datasnap.child('key5').val();
      var val6=datasnap.child('key6').val();
      var val7=datasnap.child('key7').val();
      var val8=datasnap.child('key8').val(); 
      var res=datasnap.child('res').val();
      var val9=datasnap.child('key9').val();
      var val10=datasnap.child('key10').val();
      var val11=datasnap.child('key11').val();
      var val12=datasnap.child('key12').val();
      var user=self.fdb.list('Andrapradesh/'+self.district+'/'+self.area+'/'+self.school+'/feedback/'+self.feedbackForm.get('user').value);
       user.set('key1',(val1+parseInt(self.feedbackForm.get('1').value))/2);
       user.set('key2',(parseInt(self.feedbackForm.get('2').value)+val2)/2);
       user.set('key3',(parseInt(self.feedbackForm.get('3').value)+val3)/2);
       user.set('key4',(parseInt(self.feedbackForm.get('4').value)+val4)/2);
       user.set('key5',(parseInt(self.feedbackForm.get('5').value)+val5)/2);
       user.set('key6',(parseInt(self.feedbackForm.get('6').value)+val6)/2);
       user.set('key7',(parseInt(self.feedbackForm.get('7').value)+val7)/2);
       user.set('key8',(parseInt(self.feedbackForm.get('8').value)+val8)/2);
       user.set('key9',(parseInt(self.feedbackForm.get('9').value)+val9)/2);
       user.set('key10',(parseInt(self.feedbackForm.get('10').value)+val10)/2);
       user.set('key11',(parseInt(self.feedbackForm.get('11').value)+val11)/2);
       user.set('key12',(parseInt(self.feedbackForm.get('12').value)+val12)/2);
       user.set('res',(res+1));
    }
    else{
      var user=self.fdb.list('Andrapradesh/'+self.district+'/'+self.area+'/'+self.school+'/feedback/'+self.feedbackForm.get('user').value);
       user.set('key1',self.feedbackForm.get('1').value);
       user.set('key2',self.feedbackForm.get('2').value);
       user.set('key3',self.feedbackForm.get('3').value);
       user.set('key4',self.feedbackForm.get('4').value);
       user.set('key5',self.feedbackForm.get('5').value);
       user.set('key6',self.feedbackForm.get('6').value);
       user.set('key7',self.feedbackForm.get('7').value);
       user.set('key8',self.feedbackForm.get('8').value);
       user.set('key9',self.feedbackForm.get('9').value);
       user.set('key10',self.feedbackForm.get('10').value);
       user.set('key11',self.feedbackForm.get('11').value);
       user.set('key12',self.feedbackForm.get('12').value);
       user.set('res',1);
      ...
      TeacherPercentageList:Observable<any>;
      ans1:any;
      res:any;
       ans2:any;
        ans3:any;
      ...
      getPercentage(user){
        var self=this;
        this.fdb.database.ref('Andrapradesh/'+this.district+'/'+this.area+'/'+this.school+'/feedback/'+user).on('value',function(data){
          self.ans1=data.child('key1').val();
          self.ans2=data.child('key2').val();
          self.ans3=data.child('key3').val();
          self.ans4=data.child('key4').val();
          self.ans5=data.child('key5').val();
          self.ans6=data.child('key6').val();
          self.ans7=data.child('key7').val();
          self.ans8=data.child('key8').val();
          self.ans9=data.child('key9').val();
          self.ans10=data.child('key10').val();
          self.ans11=data.child('key11').val();
          self.ans12=data.child('key12').val();
          self.res=data.child('res').val();
        })
  ...
  getLocation(uid){
    if(navigator.geolocation){
      navigator.geolocation.getCurrentPosition((position)=>{
       ...
       user.set('uid',uid);
       user.set('time',time);
       user.set('user',this.loginForm.get('select').value);
